...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserCharacter.description'
        db.add_column(u'game_usercharacter', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=3000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserCharacter.description'
        db.delete_column(u'game_usercharacter', 'description')
