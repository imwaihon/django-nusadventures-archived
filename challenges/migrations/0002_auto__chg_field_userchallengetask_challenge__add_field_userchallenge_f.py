...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserChallengeTask.challenge'
        db.alter_column(u'challenges_userchallengetask', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.UserChallenge']))
        # Adding field 'UserChallenge.finished'
        db.add_column(u'challenges_userchallenge', 'finished',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserChallengeTask.challenge'
        db.alter_column(u'challenges_userchallengetask', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge']))
        # Deleting field 'UserChallenge.finished'
        db.delete_column(u'challenges_userchallenge', 'finished')
    ...
    models = {
        ...
        u'challenges.userchallengetask': {
            ...
            'challenge': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['challenges.UserChallenge']"}),
